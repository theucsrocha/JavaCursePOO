...
public class main {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < n; i++) {
			...
			HourContract c = new HourContract(date2, valueHour, duration);
		...
		System.out.printf("Name:" + worker.getName() + "%n" + "Departament:" + departament + "%n" + "Income for : " + date  + "%n" + worker.income(date.getYear(),date.getMonthValue()));
